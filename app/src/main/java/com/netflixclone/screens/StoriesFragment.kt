...
import com.netflixclone.databinding.FragmentStoriesBinding
import com.netflixclone.extensions.toMediaBsData
import kotlin.math.min

class StoriesFragment : BottomNavFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        setupUI()
        setupViewModel()
        (requireActivity() as BottomNavActivity).onStoriesFragmentViewCreated()
    }
