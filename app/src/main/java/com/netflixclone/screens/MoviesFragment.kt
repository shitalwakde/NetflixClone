...
import com.netflixclone.databinding.FragmentMoviesBinding
import com.netflixclone.extensions.toMediaBsData
import kotlin.math.min

class MoviesFragment : BottomNavFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        setupUI()
        setupViewModel()
        (requireActivity() as BottomNavActivity).onMoviesFragmentViewCreated()
    }
