...
import com.netflixclone.screens.VideoPlayerExo
...
abstract class FeedHeaderModel : EpoxyModelWithHolder<FeedHeaderModel.FeedHeaderHolder>() {
    ...
    override fun bind(holder: FeedHeaderHolder) {
        ...
        holder.playButton.setOnClickListener { onPlayClick() }
...
//     $str_video_url= http://pixeldev.in/webservices/movie_app/movie_admin/movie_video/endgame.mp4
    }
